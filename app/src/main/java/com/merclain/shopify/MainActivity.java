...
public class MainActivity extends AppCompatActivity
    ...
    GraphClientShopify shopifyclient;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shopifyclient = (GraphClientShopify) getApplication();
...
//        QueryGraphCall call_products = shopifyclient.graphClient.queryGraph(Storefront.query(rootQuery -> rootQuery
